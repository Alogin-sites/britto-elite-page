...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="relative py-32 border-b border-primary/10 overflow-hidden" ref={ref}>
      {/* Three.js Background */}
        ...
        <div className="max-w-6xl mx-auto space-y-16">
          ...
          <div className={`text-center space-y-4 transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
            <div className="inline-block px-4 py-1 border border-primary/20 mb-4">
              <span className="text-sm tracking-widest text-muted-foreground">PORTFOLIO</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Interfaces premium que combinam <span className="text-foreground font-semibold">design excepcional</span> com <span className="text-foreground font-semibold">código limpo</span>
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6 pt-4">
                <div className="space-y-3">
                  ...
                  <h3 className="text-4xl font-bold tracking-tight">{selectedProject.title}</h3>
